...
[![CI Build](https://github.com/PatrickDeisinger/gh-demo-lib/actions/workflows/ci.yml/badge.svg)](https://github.com/PatrickDeisinger/gh-demo-lib/actions/workflows/ci.yml)
...
repositories {
    ...
    maven {
        name = "GitHubPackages"
        url = uri("https://maven.pkg.github.com/PatrickDeisinger/gh-demo-lib")
        credentials {
